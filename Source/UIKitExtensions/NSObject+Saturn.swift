...
extension NSObject: SaturnObject {
    ...
    public func loadIntoParent(_ parent: AnyObject) { }
    
    public func setAttribute(_ value: String, forProperty property:String) {
        switch property {
        case "id":
            id = value
        default: break
    ...
    public func objectsWithId(_ id: String) -> [AnyObject] {
        return []
    }
